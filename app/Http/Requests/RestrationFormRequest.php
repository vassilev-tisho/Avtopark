...
class RestrationFormRequest extends FormRequest
{
    /**
    ...
    public function messages()
    {
        return [
            ...
            'bulstat.unique'     => 'В базата вече има регистрирана фирма с този Булстат!',
            'bulstat.digits'     => 'Полето Булстат трябва да съдържа точно 10 символа!'
