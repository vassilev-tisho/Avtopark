			...
			<div class="col-md-8">
				<div class="card">
					<div class="card-header" data-background-color="purple">
						<h4 class="title">Редактиране на услуга</h4>
						<p class="category">Форма за редактиране на съществуваща услуга</p>
					</div>
					<div class="card-content">
						<form method="POST">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group label-floating {{$errors->has('priceLoaded') ? 'has-error' : ''}}" >
										...
										<input type="number" step="0.01" class="form-control" name="priceLoaded" id="priceLoaded" value="{{$service->priceLoaded}}">
								...
								<div class="col-md-3">
									<div class="form-group label-floating {{$errors->has('priceUnLoaded') ? 'has-error' : ''}}" >
										...
										<input type="number" step="0.01" class="form-control" name="priceUnLoaded" id="priceUnLoaded" value="{{$service->priceUnLoaded}}">
								...
								<div class="col-md-3">
									<div class="form-group label-floating {{$errors->has('minWeight') ? 'has-error' : ''}}" >
										...
										<input type="number" class="form-control" name="minWeight" id="minWeight" value="{{$service->minWeight}}">
								...
								<div class="col-md-3">
									<div class="form-group label-floating {{$errors->has('maxWeight') ? 'has-error' : ''}}" >
										...
										<input type="number" class="form-control" name="maxWeight" id="maxWeight" value="{{$service->maxWeight}}">
							...
							<input type="hidden" name="srvd" value="{{$service->id}}" />
							<button type="submit" class="btn btn-primary pull-right">Записване</button>
						</form>
					</div>
